...
- The 'C' key toggles wireframe / debug rendering
...
1. Implement WASD movement for the player such that it moves u/l/d/r when
   ...
   as soon as possible without worrying about implementing 
2. Implement Scene_Zelda::loadLevel(), which will allow you to load the
